...
if(d1=="na")
{
   alert("Please Select the Depth Unit");
}
...
if(w1=="na")
{
   alert("Please Select the Width Unit")
}
...
if(σc1=="na")
{
   alert("Please Select the Conductivity of Conductor Unit")
}
...
if(σd1=="na")
{
   alert("Please Select the Conductivity of Dielectric Unit")
}
...
if(δ1=="unit")
{
   alert("Please Select the Skindepth Unit");
}
...
// if(f1=="unit")
// {
//    alert("Please Select the Frequency Unit");
// }
...
var r=2/(w * parseFloat(σc)* parseFloat(δ));
